...
public class NPCMovementComponent implements Component<NPCMovementComponent> {
     ...
     * freshly each time would lead to rounding mistakes that cumulate.
     */
    public float yaw;

    /**
     * Position to which the character will move to in a straight line. For advanced pathing, a behavior tree should
