...
public class NPCMovementComponent implements Component {
    /**
     * Angle in degree in which the character will look at. Used to simulate constant yaw input. Calculating it freshly
     * each time would lead to rounding mistakes that commulate.
     */
    public float yaw;

    /**
     * Position to which the charcter will move to in a straight line. For advanced pathing, a behavior tree should be
     * used that sets this field to the next waypoint of the calculated path to the target.
     */
